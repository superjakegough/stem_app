    ...
    <div>
      <Grid container direction="column" justify="center" alignItems="center" className="mt-48 mb-48">
        <Grid item sm={10} xs={12} >
          ...
          <p className={classes.bodyHeader}>Collection and use of personal data</p>
          <p className={classes.bodyHeader}>Purpose of processing and legal basis</p>
          <p>
          ...
          <p className={classes.bodyHeader}>Statutory/contractual requirement</p>
          <p>
          ...
          <p className={classes.bodyHeader}>Changes to this privacy statement</p>
          <p>
